...
public class AssetBundleEditor
{
    ...
    [UnityEditor.MenuItem("AssetBundle/ビルド(Android 向け)", false)]
    static private void BuildAssetBundlesForWindows64()
    {
        // 他プラットフォームを対象にする場合はここを変更する(今回はAndroid向け)
        UnityEditor.BuildTarget target_platform = UnityEditor.BuildTarget.Android;
