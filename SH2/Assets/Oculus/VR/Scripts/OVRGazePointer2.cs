...
/// </summary>
public class OVRGazePointer2 : OVRCursor
{
    ...
    private static OVRGazePointer2 _instance;
    public static OVRGazePointer2 instance
    {
        ...
        get
        {
            if (_instance == null)
            {
                ...
                _instance = (OVRGazePointer2)GameObject.Instantiate((OVRGazePointer2)Resources.Load("Prefabs/GazePointerRing", typeof(OVRGazePointer2)));
            }
            return _instance;
        }
